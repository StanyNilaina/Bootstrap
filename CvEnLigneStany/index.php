...
<body id="page-top">
    <nav class="navbar navbar-light navbar-expand-lg fixed-top bg-secondary text-uppercase" id="mainNav">
        <div class="container"><a class="navbar-brand js-scroll-trigger" href="#page-top">Développeur</a><button data-toggle="collapse" data-target="#navbarResponsive" class="navbar-toggler text-white bg-primary navbar-toggler-right text-uppercase rounded" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><i class="fa fa-bars"></i></button>
    ...
    <header class="text-center text-white bg-primary masthead">
        <div class="container"><img class="img-fluid d-block mx-auto mb-5" src="assets/img/profile.png">
            <h1>Stany Nilaina</h1>
            <hr class="star-light">
            <h2 class="font-weight-light mb-0">Développeur Web&nbsp; - Designer - Freelancer</h2>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto">
                    <p class="lead">Développeur Web en freelance. J'ai des connaissances sur plusieurs langage telle que:&nbsp; HTML5, CSS3, JavaScript, Ecma-Script 06 et encore plus. Vous pouvez le voir mon CV ci-dessous.</p>
                </div>
                <div class="col-lg-4 mr-auto">
                    <p class="lead">Je suis aussi disponible pour tous types de missions. J'assure l'accomplissement de vos projets du début jusqu'à la fin et propose un service de suivi et de maintenance. Pour plus d'info, vous pouvez me contacter ou consulter le CV.&nbsp;</p>
                </div>
            </div>
            <div class="text-center mt-4"><a class="btn btn-outline-light btn-xl" role="button" href="./assets/img/StanyCV(1).pdf"><i class="fa fa-download mr-2"></i><span>Voulez-vous mon CV ?</span></a></div>
        </div>
    </section>
    <section id="contact">
        <div class="container">
            <h2 class="text-uppercase text-center text-secondary mb-0">Contact</h2>
            <hr class="star-dark mb-5">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    <form id="contactForm" method="post" action="./lib/formail.php">
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2"><label>Name</label><input class="form-control" type="text" id="name" name="name" placeholder="Name" required="true"><small class="form-text text-danger help-block"></small></div>
                        </div>
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2"><label>Email Address</label><input class="form-control" type="email" name="email" id="email" placeholder="Email Address" required><small class="form-text text-danger help-block"></small></div>
                        </div>
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-0 pb-2"><label>Phone Number</label><input class="form-control" type="tel" id="phone" name="tel" placeholder="Phone Number"><small class="form-text text-danger help-block"></small></div>
                        </div>
                        <div class="control-group">
                            <div class="form-group floating-label-form-group controls mb-5 pb-2"><textarea class="form-control" id="message"  placeholder="Message" name="msg" rows="5" required></textarea><small class="form-text text-danger help-block"></small></div>
                        </div>
                        <div id="success"></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-5 mb-lg-0">
                    ...
                    <p>Stany Nilaina<br>Madagascar, Tananarive, 101</p>
                </div>
                <div class="col-md-4 mb-5 mb-lg-0">
                    <h4 class="text-uppercase">Info sur le Web</h4>
                    <ul class="list-inline">
                        <li class="list-inline-item"><a class="btn btn-outline-light text-center btn-social rounded-circle" role="button" href="https://www.facebook.com/stanislasnilaina.razafindrakoto"><i class="fa fa-facebook fa-fw"></i></a></li>
                        <li class="list-inline-item"><a class="btn btn-outline-light text-center btn-social rounded-circle" role="button" href="#"><i class="fa fa-instagram fa-fw"></i></a></li>
                        <li class="list-inline-item"><a class="btn btn-outline-light text-center btn-social rounded-circle" role="button" href="www.linkedin.com/in/stanislas-nilaina-razafindrakoto-078882211"><i class="fa fa-linkedin fa-fw"></i></a></li>
                        <li class="list-inline-item"><a class="btn btn-outline-light text-center btn-social rounded-circle" role="button" href="https://github.com/StanyNilaina"><i class="fa fa-github fa-fw"></i></a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h4 class="text-uppercase mb-4">Offre</h4>
                    <p class="lead mb-0"><span>Créer votre site Internet en confiant les tâches à un professionnel :)</span></p>
                </div>
            </div>
        </div>
    </footer>
    <div class="text-center text-white copyright py-4">
        <div class="container"><small>Copyright © StanyNilaina 2022</small></div>
    </div>
